                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <!--formulario de actualizar-->
                                        ...
                                        <button type="submit" class="btn btn-primary" onclick="return confirm('¿Estas seguro de enviar estos datos?')">Actualizar</button>
            ...
            <table class="table mx-auto"id="tablaPublicaciones">
                ...
                <tbody style="color:white">
                    ...
                    <tr>
                        ...
                        <td><img style="width:100px" src="<?php echo $row['archivo']; ?>" alt="Imagen de perfil"></td>
                        <td><?php echo $row['titulo'] ?></td>
                        ...
                        <div class="modal fade" id="editModal<?php echo $row['idpublicaciones']; ?>" tabindex="-1"aria-labelledby="editModalLabel<?php echo $row['idpublicaciones']; ?>" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editModalLabel<?php echo $row['id']; ?>">Editar Publicación</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
