...
if ($stmt) {
    $stmt->bind_param("sssssssssi", $nuevoNombre, $nuevoCorreo, $nuevoFono, $nuevoCargo, $nuevaDescripcion, $nuevoGrado, $nuevaContrasena, $nuevasAreasInteres, $rutaImagen, $idActualizar);
